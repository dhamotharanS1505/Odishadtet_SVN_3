...
(function ($) {
    ...
    $.jqPagination = function (el, options) {
        ...
        base.init = function () {
            ...
            base.$input.on('focusout.jqPagination keydown.jqPagination', function (event) {
        ...
        base.setPage = function (page, prevent_paged) {
            ...
            var current_page = parseInt(base.options.current_page, 10),
                ...
                max_alpha = base.options.max_alpha;
            ...
            if (isNaN(parseInt(page, 10))) {
                ...
                if (page != "" && current_page != 0) {
                    ...
                    if ($(".active").parent().hasClass("xxx")) {
                        var current_page_nav = $(".active")[0].rel;
                    }
                    else {
                        var current_page_nav = $(".active").find("a")[0].rel;
                    }

                }

                var first_page_nav = "0";

                switch (page) {

                    case 'first':
                        page = 0;
                        page_nav = first_page_nav;
                        break;
                    ...
                    case 'previous':
                        page = current_page - 1;
                        if (page != 0) {
                            page_nav = $($(".xx")[page - 1]).find("a")[0].rel;
                        }
                        else {
                            page_nav = "0";
                        }
                    ...
                    case 'last':
                        page = max_page;
                        page_nav = $($(".xx")[max_page - 1]).find("a")[0].rel;
                        break;
            ...
            //added by karthi on 16-8-2014
            //            alert("fn");
            //            alert(page);
            ShowActiveMenu(page_nav);
            // update the input element
