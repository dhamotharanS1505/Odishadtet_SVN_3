; (function (window, document, undefined) {
    ...
    (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++) s(r[o]); return s })({ 1: [function (require, module, exports) {
        ...
        */
        ...
        var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('./modules/handle-ShowAlert-dom');
        ...
        */
        var sweetAlert, ShowAlert;

        exports['default'] = sweetAlert = ShowAlert = function () {
            ...
            */
            ...
            switch (typeof customizations) {
                ...
                // Ex: ShowAlert("Hello", "Just testing", "info"); 
                case 'string':
                ...
                // Ex: ShowAlert({ title:"Hello", text: "Just testing", type: "info" }); 
                case 'object':
        ...
        */
        sweetAlert.setDefaults = ShowAlert.setDefaults = function (userParams) {
            if (!userParams) {
        ...
        */
        sweetAlert.close = ShowAlert.close = function () {
            var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
        ...
        */
        sweetAlert.showInputError = ShowAlert.showInputError = function (errorMessage) {
            var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
        ...
        */
        sweetAlert.resetInputError = ShowAlert.resetInputError = function (event) {
        ...
        */
        sweetAlert.disableButtons = ShowAlert.disableButtons = function (event) {
            var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
        ...
        */
        sweetAlert.enableButtons = ShowAlert.enableButtons = function (event) {
            var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
            var $confirmButton = modal.querySelector('button.confirm');
            var $cancelButton = modal.querySelector('button.cancel');
        ...
        if (typeof window !== 'undefined') {
            ...
            window.sweetAlert = window.ShowAlert = sweetAlert;
        } else {
            _extend$hexToRgb$isIE8$logStr$colorLuminance.logStr('SweetAlert is a frontend module!');
        }
        module.exports = exports['default'];

    }, { "./modules/default-params": 2, "./modules/handle-click": 3, "./modules/handle-dom": 4, "./modules/handle-key": 5, "./modules/handle-ShowAlert-dom": 6, "./modules/set-params": 8, "./modules/utils": 9}], 2: [function (require, module, exports) {
        'use strict';
        ...
        var _getModal = require('./handle-ShowAlert-dom');
    ...
    }, { "./handle-dom": 4, "./handle-ShowAlert-dom": 6, "./utils": 9}], 4: [function (require, module, exports) {
        'use strict';
      ...
      padding;
        ...
        var _setFocusStyle = require('./handle-ShowAlert-dom');
    ...
    }, { "./handle-dom": 4, "./handle-ShowAlert-dom": 6}], 6: [function (require, module, exports) {
        'use strict';
...
"<h2>Title</h2>\n" +
        ...
        // Warning icon
"<div class=\"sa-icon sa-warning\">\n    <b><i class=\"fa fa-exclamation\"></i></b>  <span class=\"sa-body\"></span>\n      <span class=\"sa-dot\"></span>\n    </div>" +

        // Info icon
"<div class=\"sa-icon sa-info\"><b><i class=\"fa fa-question\"></i></b></div>" +

        // Success icon
"<div class=\"sa-icon sa-success\">\n      <b><i class=\"fa fa-check\"></i></b> <span class=\"sa-line sa-tip\"></span>\n      <span class=\"sa-line sa-long\"></span>\n\n      <div class=\"sa-placeholder\"></div>\n      <div class=\"sa-fix\"></div>\n    </div>" + "<div class=\"sa-icon sa-custom\"></div>" +
...
"</div>";
        ...
        var _getModal$getInput$setFocusStyle = require('./handle-ShowAlert-dom');
            ...
            if (params.type && !_isIE8.isIE8()) {
                var _ret = (function () {
                    ...
                    switch (params.type) {
                        ...
                        case 'error':
                            _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.addClass($icon, '');
                        ...
                        case 'prompt':
                            ...
                            setTimeout(function () {
                                $input.focus();
                                $input.addEventListener('keyup', ShowAlert.resetInputError);
                            }, 400);
                            break;
                    }
                })();
    ...
    }, { "./handle-dom": 4, "./handle-ShowAlert-dom": 6, "./utils": 9}], 9: [function (require, module, exports) {
        'use strict';
...
$('sa-icon sa-error animateErrorIcon').removeClass('animateErrorIcon');
})